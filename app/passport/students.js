        ...
        if (!req.user) {
          Students.findOne({
            ...
            // if everything is good register the user information and wait for email verification
              ...
              // create the user
              var studentsUser = new User();
              studentsUser.email = email;
              studentsUser.password = studentsUser.generateHash(password);
              studentsUser.name = req.body.name;
              studentsUser.emailConfirmed = false;
              studentsUser.emailConfirmationToken = emailHash;

              studentsUser.save(function (err) {
                if (err) {
                  return done(err);
                }
